        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-button">
                    <a href="{{ route('cashout.create') }}" class="btn btn-primary">Add New</a>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        ...
                                                        <form action="{{ route('cashout.destroy', $item->id) }}" method="POST" class="ml-2" enctype="multipart/form-data">
                                                            @csrf
                                                            @method('DELETE')
